...
L2 regularization is a technique to discourage the complexity of the model. It does this by penalizing the loss function. The coeffficient beta is restricted and this helps to solve the overfitting problem.  It makes those terms negligible and helps simplify the model, thus the optimal solution won't be influnced by data fluction.
...
- Get the data and import the data in the workspace.
- split the data into training set and testing set.
- Using CV , split training data set into sub-training set and validation set and build a better model using LASSO regression. 
